...
curl -H 'Content-Type: application/json' \
	-d '{"name": "adben-mc", "id" : 3, "avatar": "https://cdn.intra.42.fr/users/de7e6b8845aea12744adeaeefb48dbc8/small_adben-mc.jpg", "blocked_users": [2], "friend_users": [4], "channels": ["Transcendence", "Illuminatis"], "connected": false, "in_game": false, "game_id": -1, "last_games": [ { "has_won": "true", "opponnent": "clmurphy", "score": ["10", "6"] }, { "has_won": "true", "opponnent": "nguiard", "score": ["10", "4"] } ]}' \
	-X POST \
...
curl -H 'Content-Type: application/json' \
	-d '{"name":"nguiard", "id" : 2, "avatar":"https://cdn.intra.42.fr/users/2a54f27654e8ff846ba033f7ba41caf5/small_nguiard.jpg","blocked_users":[3],"friend_users":[4,1],"channels":["Illuminatis"],"connected":true,"in_game":true,"game_id":2,"last_games":[{"has_won":true,"opponnent":"clmurphy","score":[10,0]},{"has_won":false,"opponnent":"adben-mc","score":[4,10]}]}'  \
	-X POST \
	localhost:3042/user/update
