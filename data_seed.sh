...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/user/create | python -m json.tool
...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/user/update | python -m json.tool
...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/channel/create | python -m json.tool
...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/channel/join | python -m json.tool
...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/channel/chan/message | python -m json.tool
...
curl -H 'Content-Type: application/json' \
	...
	-X POST \
	localhost:3042/channel/supergroupe/message | python -m json.tool
